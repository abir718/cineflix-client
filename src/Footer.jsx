        ...
        <div>
            ...
            <div className="bg-[#1b1b1b]">
                <div className="flex items-center justify-center gap-2 pt-10">
                    <img className="w-28" src="/public/images/logo.png" alt="" />
                    <p className="text-[#DD003F] font-medium text-xl">CineFlix</p>
                </div>
            <footer className="footer  text-base-content text-lg p-10 flex items-center justify-around">
                <nav>
                ...
                <nav>
                    <h6 className="font-bold text-xl text-white mb-4">Social</h6>

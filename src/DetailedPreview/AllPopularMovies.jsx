                ...
                {paginatedMovies.map((movie) => (
                    <div key={movie.id} className="bg-[#232323] p-2 rounded-lg group w-fit">
                        ...
                        <div className="flex justify-between mt-2">
                            ...
                            <h1 className="text-white w-40 h-14 hover:text-[#DD003F] transition duration-300 cursor-pointer" title={movie.title}>{movie.title.length > 36 ? movie.title.slice(0, 36) + '...' : movie.title}</h1></Link>
